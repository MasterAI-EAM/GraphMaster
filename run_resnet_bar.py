...
def objective(trial):
  ...
  def resNet_customized(height, width, channels):
      ...
      x = bottle_block18(x, (64, 64), strides=(1, 1), with_conv_shortcut=False)
      # x = bottle_block18(x, (64, 64), strides=(1, 1), with_conv_shortcut=False)
      # x = bottle_block18(x, (64, 64), strides=(1, 1), with_conv_shortcut=False)
      # x = bottle_block18(x, (64, 64), strides=(1, 1), with_conv_shortcut=False)

      x = bottle_block18(x, (128, 128), strides=(2, 2), with_conv_shortcut=True)
      x = bottle_block18(x, (128, 128), strides=(1, 1), with_conv_shortcut=False)
      # x = bottle_block18(x, (128, 128), strides=(1, 1), with_conv_shortcut=False)
      # x = bottle_block18(x, (128, 128), strides=(1, 1), with_conv_shortcut=False)
      # x = bottle_block18(x, (128, 128), strides=(1, 1), with_conv_shortcut=False)

      x = bottle_block18(x, (256, 256), strides=(2, 2), with_conv_shortcut=True)
      x = bottle_block18(x, (256, 256), strides=(1, 1), with_conv_shortcut=False)
      # x = bottle_block18(x, (256, 256), strides=(1, 1), with_conv_shortcut=False)
      # x = bottle_block18(x, (256, 256), strides=(1, 1), with_conv_shortcut=False)
      # x = bottle_block18(x, (256, 256), strides=(1, 1), with_conv_shortcut=False)

      x = bottle_block18(x, (512, 512), strides=(2, 2), with_conv_shortcut=True)
      x = bottle_block18(x, (512, 512), strides=(1, 1), with_conv_shortcut=False)
      x = bottle_block18(x, (512, 512), strides=(1, 1), with_conv_shortcut=False)
      # x = bottle_block18(x, (512, 512), strides=(1, 1), with_conv_shortcut=False)
      # x = bottle_block18(x, (512, 512), strides=(1, 1), with_conv_shortcut=False)
  ...
  model.compile(optimizer=tf.keras.optimizers.Adam(learning_rate=trial.suggest_float("lr", 0, 1)),loss='binary_crossentropy',metrics=['accuracy'])

  # history = model.fit(train_imgs, train_labels, validation_split=0.3, epochs=30)
  history = model.fit(train_imgs, train_labels, batch_size=trial.suggest_int("batch_size", 0, 70), epochs=20)
  model.save("./resNet_customized34_bar")
